...
public class SelectLocationActivity extends BaseActivity implements LocationSource, AMapLocationListener, PoiSearch.OnPoiSearchListener {
    ...
    private void initData() {
        ...
        for(int i = 0; i < 10; i++){
            LatLonPoint  point = new LatLonPoint(116.373242, 40.119509);
            PoiItem  poiItem = new PoiItem("i"+i, point, "宏福苑校区", "昌平区北七家宏福苑小区温都水城");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == android.R.id.home){
            ...
            intent.putExtra("title","宏福苑校区");
            intent.putExtra("snippet","昌平区北七家宏福苑小区温都水城");
            //116.373242,40.119509
            intent.putExtra("latitude",116.373242);
            intent.putExtra("longitude",40.119509);
